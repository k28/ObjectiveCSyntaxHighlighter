...
;(function()
{
	...
	function Brush()
	{
		...
		var datatypes =	'ATOM BOOL BOOLEAN BYTE CHAR COLORREF DWORD DWORDLONG DWORD_PTR ' +
						...
						'va_list wchar_t wctrans_t wctype_t wint_t signed CGFloat Int Double Bool';
		...
		var keywords =	'break case catch class copy const __finally __exception __try ' +
						...
						'using uuid virtual void volatile whcar_t while YES func repeat';
